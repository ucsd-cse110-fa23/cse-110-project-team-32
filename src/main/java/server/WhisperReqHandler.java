...
public class WhisperReqHandler implements HttpHandler {
    ...
    private String handlePost(HttpExchange httpExchange) throws IOException, URISyntaxException {
        ...
        System.out.println("[WhisperReqHandler.java] whisper sends to server: " + resultText);
        return resultText;
    }
    ...
    private String handleSuccessResponse(HttpURLConnection connection)
        ...
        generatedText = generatedText.charAt(generatedText.length()-1) == '.' ? generatedText.substring(0, generatedText.indexOf('.')) : generatedText;
