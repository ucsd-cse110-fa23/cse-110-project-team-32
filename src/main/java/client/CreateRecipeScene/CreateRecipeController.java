...
public class CreateRecipeController {
    ...
    public CreateRecipeController(CreateRecipeView createRecipeView, CreateRecipeModel createRecipeModel, AppController appController) {
        ...
        createRecipeView.setStartRecordingButtonAction(this::handleStartRecordingButtonAction);
        createRecipeView.setStopRecordingButtonAction(this::handleStopRecordingButtonAction);
        createRecipeView.setCreateDummyRecipeButtonAction(this::handleCreateDummyRecipeButtonAction);
    }
