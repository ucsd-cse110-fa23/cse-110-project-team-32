...
public class ChatGPT implements API{
    ...
    public String getOutput(){
        ...
        try {
            ...
            System.out.println("ChatGPT.java line 88. SOMETHING WENT WRONG ON GENERATE");
        }
        return null;
    }

    public Recipe generate(String mealType, String ingredients) {
        String input = createPrompt(mealType, ingredients);
        setInput(input);
        String[] colonSeparatedResultArray = prompt.split("#");
        ...
        // recipeTitle = title;
        System.out.println("ChatGPT.java line 86:" + 
                        "Title: " + title + 
                        "\n, Meal Type: " + mealType + 
